...
public class AspectConfig {
    ...
    public void logBeforeAddBill(JoinPoint joinPoint) {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Bill " + joinPoint.getArgs()[0] + " generated by User"));
    }
    ...
    public void logBeforeAddUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Created user by admin "));}
    ...
    public void logBeforeDeteleUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Deleted user by admin "));}
    ...
    public void logBeforeUpdateUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Updated user by admin "));}
