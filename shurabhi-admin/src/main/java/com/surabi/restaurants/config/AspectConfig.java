...
public class AspectConfig {
    ...
    public void logBeforeAddBill(JoinPoint joinPoint) {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Bill " + joinPoint.getArgs()[0] + " generated by User", "ram"));
    }
    ...
    public void logBeforeAddUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Created user by admin ", "ram"));}
    ...
    public void logBeforeDeteleUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Deleted user by admin ", "ram"));}
    ...
    public void logBeforeUpdateUser() {
        auditRepository.saveAndFlush(new AuditLog(new Date(), "Updated user by admin ", "ram"));}
